        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTemporaryPassword = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    ...
                    PasswordChangedCount = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Code = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Type = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "Button"),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_appactions_pages_PageId",
                        column: x => x.PageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_permissions_appactions_ActionId",
                        column: x => x.ActionId,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_appactions_pageid_code",
                table: "appactions",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_aspnetusers_tenantid_isdeleted",
                table: "aspnetusers",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_permissions_appid_pageid_actionid",
                table: "permissions",
                columns: new[] { "AppId", "PageId", "ActionId" },
                unique: true);
